...
const getSkillIcon = (skill) => {
  switch (skill) {
      ...
      return (
        <svg className="w-12 h-12" viewBox="0 0 128 128">
          <g fill="#61DAFB">
            ...
            <path d="M107.3 45.2c-2.2-.8-4.5-1.6-6.9-2.3.6-2.4 1.1-4.8 1.5-7.1 2.1-13.2-.2-22.5-6.6-26.1-1.9-1.1-4-1.6-6.4-1.6-7 0-15.9 5.2-24.9 13.9-9-8.7-17.9-13.9-24.9-13.9-2.4 0-4.5.5-6.4 1.6-6.4 3.7-8.7 13-6.6 26.1.4 2.3.9 4.7 1.5 7.1-2.4.7-4.7 1.4-6.9 2.3C8.2 50 2 57.8 2 64.2c0 6.3 6.2 14.2 18.7 19 2.2.8 4.5 1.6 6.9 2.3-.6 2.4-1.1 4.8-1.5 7.1-2.1 13.2.2 22.5 6.6 26.1 1.9 1.1 4 1.6 6.4 1.6 7 0 15.9-5.2 24.9-13.9 9 8.7 17.9 13.9 24.9 13.9 2.4 0 4.5-.5 6.4-1.6 6.4-3.7 8.7-13 6.6-26.1-.4-2.3-.9-4.7-1.5-7.1 2.4-.7 4.7-1.4 6.9-2.3 12.5-4.8 18.7-12.6 18.7-19 0-6.4-6.2-14.2-18.8-19zM92.5 14.7c4.1 2.4 5.5 9.8 3.8 20.3-.3 2.1-.8 4.3-1.4 6.6-5.2-1.2-10.7-2-16.5-2.5-3.4-4.8-6.9-9.1-10.4-13 7.4-7.3 14.9-12.3 21-12.3 1.3 0 2.5.3 3.5.9zM81.3 74c-1.8 3.2-3.9 6.4-6.1 9.6-3.7.3-7.4.4-11.2.4-3.9 0-7.6-.1-11.2-.4-2.2-3.2-4.2-6.4-6-9.6-1.9-3.3-3.7-6.7-5.3-10 1.6-3.3 3.4-6.7 5.3-10 1.8-3.2 3.9-6.4 6.1-9.6 3.7-.3 7.4-.4 11.2-.4 3.9 0 7.6.1 11.2.4 2.2 3.2 4.2 6.4 6 9.6 1.9 3.3 3.7 6.7 5.3 10-1.7 3.3-3.4 6.6-5.3 10zm8.3-3.3c1.5 3.5 2.7 6.9 3.8 10.3-3.4.8-7 1.4-10.8 1.9 1.2-1.9 2.5-3.9 3.6-6 1.2-2.1 2.3-4.2 3.4-6.2zM64 97.8c-2.4-2.6-4.7-5.4-6.9-8.3 2.3.1 4.6.2 6.9.2 2.3 0 4.6-.1 6.9-.2-2.2 2.9-4.5 5.7-6.9 8.3zm-18.6-15c-3.8-.5-7.4-1.1-10.8-1.9 1.1-3.3 2.3-6.8 3.8-10.3 1.1 2 2.2 4.1 3.4 6.1 1.2 2.2 2.4 4.1 3.6 6.1zm-7-25.5c-1.5-3.5-2.7-6.9-3.8-10.3 3.4-.8 7-1.4 10.8-1.9-1.2 1.9-2.5 3.9-3.6 6-1.2 2.1-2.3 4.2-3.4 6.2zM64 30.2c2.4 2.6 4.7 5.4 6.9 8.3-2.3-.1-4.6-.2-6.9-.2-2.3 0-4.6.1-6.9.2 2.2-2.9 4.5-5.7 6.9-8.3zm22.2 21.1c-1.2-2.1-2.4-4.2-3.6-6.2 3.8.5 7.4 1.1 10.8 1.9-1.1 3.3-2.3 6.8-3.8 10.3-1.1-2.1-2.2-4.2-3.4-6zM31.7 35c-1.7-10.5-.3-17.9 3.8-20.3 1-.6 2.2-.9 3.5-.9 6.1 0 13.6 5 21 12.3-3.5 3.8-7 8.2-10.4 13-5.8.5-11.3 1.4-16.5 2.5-.6-2.3-1-4.5-1.4-6.6zM7 64.2c0-4.1 4.9-10.1 14.8-13.6 2.1-.7 4.3-1.4 6.6-2.1 1.2 5.2 2.9 10.7 5.1 16.1-2.2 5.4-3.9 10.9-5.1 16.1-2.3-.7-4.5-1.4-6.6-2.1C11.9 74.3 7 68.3 7 64.2zm28.5 49.3c-4.1-2.4-5.5-9.8-3.8-20.3.3-2.1.8-4.3 1.4-6.6 5.2 1.2 10.7 2 16.5 2.5 3.4 4.8 6.9 9.1 10.4 13-7.4 7.3-14.9 12.3-21 12.3-1.3 0-2.5-.3-3.5-.9zM96.3 93c1.7 10.5.3 17.9-3.8 20.3-1 .6-2.2.9-3.5.9-6.1 0-13.6-5-21-12.3 3.5-3.8 7-8.2 10.4-13 5.8-.5 11.3-1.4 16.5-2.5.6 2.3 1 4.5 1.4 6.6zm9-15.6c-2.1.7-4.3 1.4-6.6 2.1-1.2-5.2-2.9-10.7-5.1-16.1 2.2-5.4 3.9-10.9 5.1-16.1 2.3.7 4.5 1.4 6.6 2.1 9.9 3.5 14.8 9.5 14.8 13.6 0 4.2-4.9 10.1-14.8 13.6z" />
          </g>
        </svg>
      );
    ...
    case "Redux":
      return (
        <svg className="w-12 h-12" viewBox="0 0 128 128" fill="none">
          <circle cx="64" cy="64" r="50" fill="#764ABC" />
          <circle cx="64" cy="45" r="8" fill="#fff" />
          <circle cx="48" cy="75" r="8" fill="#fff" />
          <circle cx="80" cy="75" r="8" fill="#fff" />
          <path d="M64 45 L48 75 L80 75 Z" stroke="#fff" strokeWidth="3" fill="none" />
        </svg>
      );
    ...
    case "Bootstrap":
      return (
        <svg className="w-12 h-12" viewBox="0 0 128 128" fill="none">
          <rect x="10" y="25" width="108" height="78" rx="15" fill="#7952B3" />
          <text x="64" y="82" fontSize="56" fontWeight="700" fill="#fff" textAnchor="middle" fontFamily="Arial, sans-serif">B</text>
        </svg>
      );
